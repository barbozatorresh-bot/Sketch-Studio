/* script.js - Sketch Studio
   Compatible con el index.html que me diste.
   Asegúrate de tener: images/img1.jpg img2.jpg img3.jpg y folder images/store/...
*/
...
document.addEventListener('DOMContentLoaded', ()=>{
  ...
  /* ========== THEME BUTTON (created dynamically) ========== */
  ...
  /* update theme text helper (reused earlier) */
  function updateThemeText(){
    const t = document.body.classList.contains('dark') ? '☀️ Modo Claro' : '🌙 Modo Oscuro';
    themeBtn && (themeBtn.textContent = t);
  }

  // expose updateThemeText in scope
